//! Los tres sobres SOAP con los que la tienda habla con el servicio de entrega
//! de Windows Update, que es por donde viaja de verdad un paquete de la
//! Microsoft Store.
//!
//! El protocolo no admite variaciones: la lista de `InstalledNonLeafUpdateIDs`,
//! los identificadores de mensaje y las marcas de tiempo ya caducadas forman
//! parte de lo que el servidor espera recibir, y retocarlos solo consigue que
//! deje de contestar. Se copian tal cual, con tres huecos que se rellenan por
//! sustitución de texto:
//!
//! * `{1}` — la cookie cifrada de [`COOKIE`], o el UpdateID en [`DOWNLOAD_URL`].
//! * `{2}` — la categoría del producto, o el número de revisión en [`DOWNLOAD_URL`].
//! * `{3}` — el canal de publicación: `Retail`, `RP`, `WIS` o `WIF`.

/// Pide la cookie cifrada que autoriza el resto de la conversación.
pub const COOKIE: &str = r#"<Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns="http://www.w3.org/2003/05/soap-envelope">
	<Header>
...
/// Pregunta por los paquetes publicados para una categoría de producto.
pub const SYNC_UPDATES: &str = r#"<s:Envelope
...
/// Canjea la identidad de una actualización por su enlace de descarga.
pub const DOWNLOAD_URL: &str = r#"<s:Envelope
	xmlns:a="http://www.w3.org/2005/08/addressing"
	xmlns:s="http://www.w3.org/2003/05/soap-envelope">
	<s:Header>
